...
The code will also output a rough visualization of each individual simulation using baseline quantifications of network activity over moving time windows ("StatsOverTime ... .png").
