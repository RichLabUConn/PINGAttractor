...
def run_sim():
    ...
    for q in range(trials):
        ...
        str1='SpikingData_OU_Esyni%1.0f_NoiseAmp%1.0f_%d.csv' \
             % ( esyn_i, D*1000000, number)
        ...
        DC_e=Iext_e
        DC_i=Iext_i
        hist_e=np.array(histogram_SpikeRateIndividualCells(spikes_e, 1250, T,numcells_e))
        hist_i=np.array(histogram_SpikeRateIndividualCells(spikes_i, 1250, T,numcells_i))
        DCtoSpikeRate_corr_e=np.corrcoef(DC_e,hist_e)
        DCtoSpikeRate_corr_i=np.corrcoef(DC_i,hist_i)
        
        ISI_mean_e, ISI_std_e=calculate_ISIs(spikes_e, 1250, T,numcells_e)
        ISI_mean_i, ISI_std_i=calculate_ISIs(spikes_i, 1250, T,numcells_i)
        ...
        titlestr='E_GABA=%1.0f mV, Noise Amplitude=%1.6f' % (esyn_i, D)
        fig.suptitle(titlestr)
          
        plt.tight_layout()
    
    
        str2='StatsOverTime_Esyni%1.0f_NoiseAmp%1.0f_%d.png' \
            % ( esyn_i, D*1000000, number)
...
freq_FullSim_esyni=[]
MFF_FullSim_esyni=[]
meanSpikePercentagePerBurst_FullSim_esyni=[]
sync_stdOverTime_esyni=[]
freq_stdOverTime_esyni=[]
MFF_stdOverTime_esyni=[]
meanSpikePercentagePerBurst_stdOverTime_esyni=[]
sync_onset_num_esyni=[]
sync_offset_num_esyni=[]
sync_duration_esyni=[]
DCtoSpike_corr_e_esyni=[]
DCtoSpike_corr_i_esyni=[]
DCtoISImean_corr_e_esyni=[]
DCtoISImean_corr_i_esyni=[]
DCtoISIstd_corr_e_esyni=[]
DCtoISIstd_corr_i_esyni=[]
ISImeantoISIstd_corr_e_esyni=[]
ISImeantoISIstd_corr_i_esyni=[]
linreg_r_esyni=[]
linreg_slope_esyni=[]


# CSV
str1='StatsOverEsynI_OU_Trials%d_NoiseAmp%1.0f_%d.csv' \
                        ...
                        DCtoISImean_corr_e, DCtoISImean_corr_i,\
                            DCtoISIstd_corr_e, DCtoISIstd_corr_i,\
                                ISImeantoISIstd_corr_e, ISImeantoISIstd_corr_i, \
                                    linreg_r, linreg_slope =run_sim()
        
        sync_FullSim_esyni.append(sync_FullSim)
        freq_FullSim_esyni.append(freq_FullSim)
        MFF_FullSim_esyni.append(MFF_FullSim)
        meanSpikePercentagePerBurst_FullSim_esyni.append(meanSpikePercentagePerBurst_FullSim)
        sync_stdOverTime_esyni.append(sync_stdOverTime)
        freq_stdOverTime_esyni.append(freq_stdOverTime)
        MFF_stdOverTime_esyni.append(MFF_stdOverTime)
        meanSpikePercentagePerBurst_stdOverTime_esyni.append(meanSpikePercentagePerBurst_stdOverTime)
        sync_onset_num_esyni.append(sync_onset_num)
        sync_offset_num_esyni.append(sync_offset_num)
        sync_duration_esyni.append(sync_duration)
        DCtoSpike_corr_e_esyni.append(DCtoSpike_corr_e)
        DCtoSpike_corr_i_esyni.append(DCtoSpike_corr_i)
        DCtoISImean_corr_e_esyni.append(DCtoISImean_corr_e)
        DCtoISImean_corr_i_esyni.append(DCtoISImean_corr_i)
        DCtoISIstd_corr_e_esyni.append(DCtoISIstd_corr_e)
        DCtoISIstd_corr_i_esyni.append(DCtoISIstd_corr_i)
        ISImeantoISIstd_corr_e_esyni.append(ISImeantoISIstd_corr_e)
        ISImeantoISIstd_corr_i_esyni.append(ISImeantoISIstd_corr_i)
        linreg_r_esyni.append(linreg_r)
        linreg_slope_esyni.append(linreg_slope)


         
        mystr=[esyn_i, sync_FullSim, sync_stdOverTime, freq_FullSim, freq_stdOverTime, 
               MFF_FullSim, MFF_stdOverTime, meanSpikePercentagePerBurst_FullSim, meanSpikePercentagePerBurst_stdOverTime,
