...
for noiseamp in [0, 2000]:
    ...
    # CSV
    Iext_e=30
    str1='GammaQuantification75\Stats_GammaFeaturesIFRH_EGABA75_NoiseAmp%1.0f_Iext%1.0f_v2.csv' % (noiseamp, Iext_e)
    ...
    str2=r'GammaQuantification75\NonPINGDuration_EGABA75_NoiseAmp%1.0f_Iext%1.0f.csv' % (noiseamp, Iext_e)
